...
## Installation
```{r install}
pacman::p_load(leaflet, tidyverse, googlesheets4)
```
...
places <- read_sheet("https://docs.google.com/spreadsheets/d/1PlxsPElZML8LZKyXbqdAYeQCDIvDps2McZx1cTVWSzI/edit#gid=1275868348",
                     range = "2023",
                     col_types = "cccnncnc") # Column datatypes
glimpse(places)
...
leaflet() %>% 
  ...
  addMarkers(lng = places$Longitude, 
             lat = places$Latitude,
             popup = paste0(places$Placename, "<br>",  # A nice description on the pop-up
                            places$Description), 
